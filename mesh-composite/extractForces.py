...
def saveValues(filename, matrix, type=""):  # , indexes):
    with open(filename, 'w') as f:
        if type.lower == "forces":
            if params.separated:
                f.write(
                    "# time Fpx-blade0 Fpx-blade1 Fpx-blade2 Fpx-sum Ftaux-blade0 Ftaux-blade1 Ftaux-blade2 Ftaux-sum Fpy-blade0 Fpy-blade1 Fpy-blade2 Fpy-sum Ftauy-blade0 Ftauy-blade1 Ftauy-blade2 Ftauy-sum FX-sum FY-sum\n")
            else:
